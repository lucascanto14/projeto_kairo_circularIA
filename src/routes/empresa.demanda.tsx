...
export const Route = createFileRoute("/empresa/demanda")({
  head: () => ({ meta: [
    { title: "Perfil de Demanda — CircularIA" }, { name: "description", content: "Configure o perfil de baterias procuradas." },
...
function Demand() {
  const fields = [["Tipo de bateria", demandProfile.type], ["Química", demandProfile.chemistry], ["Capacidade", demandProfile.capacity], ["Quantidade", demandProfile.qty], ["Condição desejada", demandProfile.condition], ["SoH mínimo, quando aplicável", demandProfile.minSoh], ["Região de interesse", demandProfile.region], ["Finalidade", demandProfile.purpose], ["Capacidade de absorção", demandProfile.absorption], ["Frequência de compra", demandProfile.frequency]];
